        ...
        {loading ? (
          ...
          <div className="h-36 flex flex-col items-center justify-center gap-3">
            ...
            <span className="font-bold text-[11px] uppercase tracking-widest opacity-25 text-center px-6">
              Ensure <code className="font-mono">blockTimestamp</code> is stored in the
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-6 mb-8 lg:mb-16 relative z-10">
              <div className="max-w-md">
                ...
                <p className="text-sm md:text-base font-bold opacity-70 leading-relaxed">
                  Confirmed mints (status&nbsp;3) aggregated across all connected
                  networks.
                </p>
              </div>
          ...
          <div className="p-4 md:p-6 lg:px-10 border-b-4 border-ink bg-white flex justify-between items-center">
            <div>
              ...
              <p className="text-xs md:text-sm font-bold opacity-60 mt-1 uppercase tracking-widest hidden sm:block">
                Confirmed mints × mint price per payment token, isolated by network
              </p>
            </div>
            <ArrowUpRight
